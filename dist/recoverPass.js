...
var _recoverPass = __webpack_require__(7);
...
__vue_options__.__file = "F:\\weex项目\\管理app忘记密码\\recoverPassword\\src\\components\\login.vue"
...
__vue_options__.__file = "F:\\weex项目\\管理app忘记密码\\recoverPassword\\src\\components\\recoverPass.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-20ab4d56"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  })]), (!_vm.isChangePass) ? _c('div', [_c('text', {
    staticClass: ["centerTxt"]
  }, [_vm._v("忘记密码")]), _c('div', {
    staticClass: ["inputBox"]
  }, [_c('div', {
  ...
  }), (!_vm.isSendCode) ? _c('text', {
    staticClass: ["sendCode"],
    on: {
      "click": _vm.sendCodeEvent
    }
  }, [_vm._v("发送验证码")]) : _vm._e(), (_vm.isSendCode && !_vm.reSend) ? _c('text', {
    staticClass: ["sendCode"]
  }, [_vm._v("重新发送" + _vm._s(_vm.reduceTime) + "s")]) : _vm._e(), (_vm.isSendCode && _vm.reSend) ? _c('text', {
    staticClass: ["sendCode"],
    on: {
      "click": _vm.sendCodeEvent
    }
  }, [_vm._v("重新发送")]) : _vm._e()])]), _c('text', {
    staticClass: ["login"],
    on: {
      "click": _vm.nextStep
    }
    ...
    on: {
      "input": function($event) {
        _vm.rePassword = $event.target.attr.value
      }
    }
  })])]), _c('text', {
    staticClass: ["login"],
...
__vue_options__.__file = "F:\\weex项目\\管理app忘记密码\\recoverPassword\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
